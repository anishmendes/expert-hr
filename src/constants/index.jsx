...
export const features = [
  {
    ...
    text: "Welcome to Expert HR Outsourcing Pvt. Ltd a leading provider of support services for Australian mortgage brokers and comprehensive outsourcing solutions. ",
    button: {
  ...
  },
  {
    ...
    title: "Tailored to Meet Your Needs",
    text: " In addition to supporting Australian mortgage brokers, we also extend our services to mortgage brokers in other countries",
    button: {
...
export const faq = [
  {
    ...
    answer:
      "We specialize in supporting mortgage brokers and businesses in accounting, admin, marketing, web development, and IT services.",
  },
  {
    id: "1",
    question: "Do you cater to countries outside Australia",
    answer:
      "Yes, we provide mortgage broker support to clients worldwide.",
  },
  {
    id: "2",
    question: "What mortgage broker support services do you offer?",
    answer:
      "Our services include loan application management, compliance, document handling, and stakeholder communication.",
  },
  {
    id: "3",
    question: "Can you handle financial management tasks?",
    answer:
      "Yes, we provide accounting, bookkeeping, financial reporting, and audit assistance.",
  },
  {
    id: "4",
    question: "What administrative support do you provide?",
    answer:
      "We offer scheduling, email management, virtual assistance, and document coordination.",
  },
  {
    id: "5",
    question: "What digital marketing services are available?",
    answer:
      "We provide SEO, social media management, email campaigns, and content creation.",
  },
  {
    id: "6",
    question: "Do you offer custom web development?",
    answer:
      "Yes, we build custom websites, maintain them, and optimize their performance.",
  },
  {
    id: "7",
    question: "What IT support services do you provide?",
    answer:
      "Our IT services include software maintenance, marketing strategies, and campaign performance analysis.",
  },
  {
    id: "8",
    question: "How do you support mortgage brokers with loan applications?",
    answer:
      "We manage the entire loan application process, ensuring accuracy and timely submission.",
  },
  {
    id: "9",
    question: "What compliance support do you offer for mortgage brokers?",
    answer:
      "We help mortgage brokers adhere to regulatory standards with expert compliance management services.",
  },
];
...
export const services = [
  {
      ...
      list: ['Loan Application Management', 'Regulatory Compliance', 'Document Handling', 'Stakeholder Communication'],
      delay: 100,
  },
  {
      title: 'Accounting and Bookkeeping',
      ...
      list: ['Financial Record Management', 'Financial Reporting', 'Account Reconciliation', 'Audit Assistance'],
      delay: 200,
  },
  {
      ...
      list: ['Scheduling & Calendar Management', 'Email Management', 'Virtual Assistant Services', 'Document Handling & Coordination'],
      delay: 300,
  },
  {
      title: 'Digital Marketing',
      ...
      list: ['Social Media Management', 'Content Creation', 'SEO Optimization', 'Email Marketing Campaigns'],
      delay: 0,
  },
  {
      ...
      list: ['Custom Web Development', 'E-commerce Solutions', 'Website Maintenance & Updates', 'Performance Optimization'],
      delay: 0,
  },
  {
      ...
      list: ['Technical Support & Software Maintenance', 'Business Consultant', 'Marketing Strategy Development','Campaign Performance Analysis'],
      delay: 0,
  },
];
...
export const testimonials = [
  {
    ...
    comment:
      "Their compliance management services have been a lifesaver. I no longer worry about regulatory requirements, and my business runs smoothly.",
  },
  {
    id: "1",
    name: "Suresh Poudel",
    ...
    comment:
      "Expert HR Outsourcing has streamlined my loan application process, ensuring faster approvals and happier clients. Their attention to detail is unmatched!",
  },
  {
    id: "2",
    name: "Sunita Sharma",
    ...
    comment:
      "Their administrative support team is outstanding! Scheduling and email management have never been easier for my growing business",
  },
  {
    id: "3",
    name: "Manisha Khadka",
    ...
    comment:
      "Their accounting and bookkeeping services are precise and reliable. I can now focus on expanding my business without worrying about financial management.",
  },
  {
    id: "4",
    name: "Anjana Gautam",
    ...
    comment:
      "The IT support team is incredibly responsive and efficient. Their marketing strategy development helped me launch a successful campaign seamlessly!",
  },
  {
    id: "5",
    name: "Rabin Thapa",
    ...
    comment:
      "Document handling has always been a challenge, but Expert HR Outsourcing made it effortless. My clients appreciate the efficiency!",
  },
];
